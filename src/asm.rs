    ...
    while i < toks.len() {
        ...
        if name == "label" {
         ...
         let (opcode, has_jump_label, kind) = match name.as_str() {
            ...
            "rot_z_90_r"  => (op::ROT_Z_90_R,  false, OpKind::Int),
            "rot_z_180_r" => (op::ROT_Z_180_R, false, OpKind::Int),
            "rot_z_270_r" => (op::ROT_Z_270_R, false, OpKind::Int),
            "rot_x_90_r"  => (op::ROT_X_90_R,  false, OpKind::Int),
            "rot_x_180_r" => (op::ROT_X_180_R, false, OpKind::Int),
            "rot_x_270_r" => (op::ROT_X_270_R, false, OpKind::Int),
            "rot_y_90_r"  => (op::ROT_Y_90_R,  false, OpKind::Int),
            "rot_y_180_r" => (op::ROT_Y_180_R, false, OpKind::Int),
            "rot_y_270_r" => (op::ROT_Y_270_R, false, OpKind::Int),
            "reflect_x_r" => (op::REFLECT_X_R, false, OpKind::Int),
            "reflect_y_r" => (op::REFLECT_Y_R, false, OpKind::Int),
            "reflect_z_r" => (op::REFLECT_Z_R, false, OpKind::Int),
            "neg_r"       => (op::NEG_R,       false, OpKind::Int),
            ...
            "mov_cd"    => (op::MOV_CD,    false, OpKind::Int),
            "mov_dc"    => (op::MOV_DC,    false, OpKind::Int),
            "store_d"   => (op::STORE_D,   false, OpKind::Int),
            "load_d"    => (op::LOAD_D,    false, OpKind::Int),
             "iadd"      => (op::IADD,      false, OpKind::Int),
            "cycle_x"   => (op::CYCLE_X,   false, OpKind::None),
            "cycle_y"   => (op::CYCLE_Y,   false, OpKind::None),
            "cycle_z"   => (op::CYCLE_Z,   false, OpKind::None),
            "cube_add"  => (op::CUBE_ADD,  false, OpKind::None),
